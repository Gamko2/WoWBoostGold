...
var alts = require("../Util/alts.json");
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, axios_1["default"].get(url)
                    ...
                    var s = new Date(response.data.start).toLocaleTimeString("en-US");
                    console.log(s);
                    for (var i = 0; i < response.data.exportedCharacters.length; i++) {
                        for (var key in alts.characters) {
                            for (var k = 0; k < alts.characters[key].length; k++) {
